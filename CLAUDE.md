...
- **Test command:** `cd exporter/agentauditexporter && go test -race ./...`
- **Lint command:** `cd exporter/agentauditexporter && golangci-lint run`
- **Build command:** `GOWORK=off builder --config=ocb/builder-config.yaml`
